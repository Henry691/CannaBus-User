...
class MedicinalDetails extends StatefulWidget {
  final MedicinalModel medicinal;

  const MedicinalDetails({Key key, this.medicinal}) : super(key: key);

  @override
  _MedicinalDetailsState createState() => _MedicinalDetailsState();
}

class _MedicinalDetailsState extends State<MedicinalDetails> {
  ...
  void initState() {
    ...
    _size = widget.medicinal.sizes[0];
  }
              ...
              children: <Widget>[
                ...
                Center(
                  child: FadeInImage.memoryNetwork(
                    ...
                    image: widget.medicinal.picture,
                    fit: BoxFit.contain,
                    height: 500,
